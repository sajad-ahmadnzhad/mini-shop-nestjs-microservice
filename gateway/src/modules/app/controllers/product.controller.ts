import { Body, Controller, Delete, Get, HttpException, Inject, InternalServerErrorException, Param, ParseIntPipe, Post, Put } from "@nestjs/common";
...
export class ProductController {
    ...
    async update(@Param('id', ParseIntPipe) id: number, @Body() updateProductDto: UpdateProductDto) {
        ...
        const data: ServiceResponse = await lastValueFrom(this.productServiceClientProxy.send('update-product', { ...updateProductDto, id, creatorId: 1 }).pipe(timeout(5000)))
